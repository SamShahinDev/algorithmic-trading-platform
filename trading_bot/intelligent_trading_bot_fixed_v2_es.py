...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/Users/royaltyvixion/Documents/XTRADING/trading_bot/es_bot_fixed_v2.log'),
...
# Momentum Thrust and TrendLineBounce are ENABLED - they're profitable!
DISABLED_PATTERNS = ['volume_climax', 'bollinger_squeeze']  # Only disable truly poor performers
...
class IntelligentTradingBotFixedV2:
    ...
    def __init__(self, 
        ...
        """Initialize fixed intelligent trading bot V2 for ES"""
        self.account_id = account_id
        self.symbol = symbol
        self.mode = mode
        self.state = BotState.INITIALIZING
        
        # Contract ID for ES (E-mini S&P 500)
        self.contract_id = "CON.F.US.EEZ.U25"  # ES December 2025 contract
    ...
    async def _look_for_entry(self, data: pd.DataFrame):
        ...
        try:
            ...
            if valid_patterns:
                ...
                logger.info(f"Pattern detected: {strongest_pattern.pattern_type} with direction {strongest_pattern.direction}")
                ...
                selected_pattern = strongest_pattern.pattern_type
...
if __name__ == "__main__":
    logger.info("=" * 60)
    logger.info("FIXED V2 ES Bot - With Momentum Thrust & TrendLineBounce")
    logger.info("=" * 60)
    asyncio.run(main())