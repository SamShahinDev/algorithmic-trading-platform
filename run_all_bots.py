#!/usr/bin/env python3
"""
Run all three trading bots (NQ, ES, CL) simultaneously on TopStepX
"""
...
class BotOrchestrator:
    ...
    async def start_all(self):
        ...
        if all(results):
            ...
            logger.info("Press Ctrl+C to stop all bots gracefully")
...
if __name__ == "__main__":
    ...
    print("""
    ⚠️  IMPORTANT: This will start LIVE TRADING on your TopStepX account!
    ...
    input("Press Enter to start all bots...")
