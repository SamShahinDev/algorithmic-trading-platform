...
class DataCache:
    ...
    def _rebuild_higher_tfs(self):
        ...
        # 5m bars
        self.bars_5m = (self.bars_1m.resample("5T", label="right", closed="right", origin="epoch")
    ...
    def get_bars(self, timeframe: Literal['1m', '5m', '1h']) -> pd.DataFrame:
        ...
        return mapping.get(timeframe, pd.DataFrame())
