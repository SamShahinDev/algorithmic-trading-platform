...
class TechnicalAnalysisFallback:
    ...
    def __init__(self, data_cache=None):
        ...
        # Risk parameters - OPTIMIZED FOR TOPSTEPX $150 TARGET
        self.default_stop_ticks = 25  # $125 stop = 25 ticks
        self.default_target_ticks = 30  # $150 target = 30 ticks
    ...
    def _create_enhanced_signal(self, action: str, price: float, score: float,
        ...
        target_distance = max(30 * self.tick_size, atr * 2.0)  # 30 ticks for $150 target
    ...
    def _update_levels(self, data: pd.DataFrame, indicators: Dict):
        ...
        if 'volume' in data.columns and len(data) > 50:
            ...
            volume_profile = data.groupby(price_levels, observed=False)['volume'].sum()
